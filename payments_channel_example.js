...
const init = async () => {
    ...
    const apiKey = '5e368204e7e4ea3750c6e6c01f4594692bb05ad04e82b8778ac4073afc64e0ca'; // Obtain your API key in https://t.me/tontestnetapibot
    ...
    //newSecretKey = tonweb.utils.newSeed(); // Uint8Array

    const mnemonic = ['access','once','business','talent','fuel','trigger','athlete','canal',
        'outside','burger','inspire','inquiry','lady','crew','rescue','squeeze',
        'uphold','section','coyote','people','find','satoshi','process','roast'
    ]
